...
//    var image = new google.maps.MarkerImage("https://maps.google.com/mapfiles/kml/pal3/icon52.png",
    var image = new google.maps.MarkerImage("icon52.png",
...
//            	dist = (Math.round((dist)*10)/10).toFixed(1);
	...
	if((rangeChange && ShowRange) || ShowRangeSet){
		drawRangeLine();
		ShowRangeSet = false;
	}
	//drawRangeLine();
